...
Modify the `main.py` with the options you like and run it. You may save the out in a file using this command `python main.py > output.txt`. This would serve as your system propt for your favourite LLM.
...
4. Set the options in `main.py` and run it. Use `python main.py > output.txt` to save the output in `output.txt` file.
